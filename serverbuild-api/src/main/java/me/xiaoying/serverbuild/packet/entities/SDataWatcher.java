...
public abstract class SDataWatcher implements SProxy {
    ...
    public abstract List<Object> getItemListV1_20_R1();
    ...
    public abstract void setV1_20_R1(@SParameter(index = 0, truthClass = "net.minecraft.network.syncher.DataWatcherObject") Object dataWatcherObject, @SParameter(index = 1) Object value, @SParameter(index = 2) boolean force);
}