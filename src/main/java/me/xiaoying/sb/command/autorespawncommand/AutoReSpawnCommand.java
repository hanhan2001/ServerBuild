package me.xiaoying.sb.command.autorespawncommand;
...
public class AutoReSpawnCommand implements TabExecutor {
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String s, @NotNull String[] args) {
        ...
        if (args == null || args.length == 0) {
            AutoReSpawnConstant.MESSAGE_HELP.forEach(string -> sender.sendMessage(ColorUtil.translate(string)));
            return false;
        }
